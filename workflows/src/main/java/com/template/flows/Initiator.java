...
import com.template.contracts.GoodContract;
...
public class Initiator extends FlowLogic<SignedTransaction> {
    ...
    public SignedTransaction call() throws FlowException {
        ...
        builder.addCommand(new GoodContract.Commands.Send(), Arrays.asList(this.sender.getOwningKey(),this.receiver.getOwningKey()) );
